...
import { Wifi, WifiOff, Zap, Cloud, RefreshCw } from "lucide-react";
    ...
    switch (connectionMode) {
      case "p2p":
        return {
          ...
          description: "Ultra-low latency via WebRTC",
        };
      case "websocket":
        return {
          icon: Wifi,
          ...
          description: "Direct connection via WebSocket",
        };
      case "fallback":
        return {
          icon: Cloud,
          ...
          description: "Using cloud relay (higher latency)",
        };
      default:
        return {
          icon: WifiOff,
    ...
    <div className="rounded-lg border bg-card p-3 space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        ...
        <div className="space-y-1">
          ...
          <div className="font-mono">
            {networkState.pc?.localIp || "Waiting..."}
          </div>
        </div>
      </div>
